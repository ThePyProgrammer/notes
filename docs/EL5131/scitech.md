This is a combination of points from S&T **and** 4IR.
...
- 400k jobs lost to automation in US factories (1997 - 2007)
- 40M jobs shed during the pandemic, 42% of these jobs are gone forever
- A paper by MIT and Boston Uni Economists found that robots can replace nearly 2 million more workers in manufacturing by 2025
- Targetting Blue Collar Worker jobs
	- Higher Social Stratification between the two income groups
	- Most Blue Collar Workers are from marginalized races (e.g. African American, Latino/Latinx), more racial segregation
...
## General 4IR Stuff
- A [2017 study](http://documents.epo.org/projects/babylon/eponet.nsf/0/17FDB5538E87B4B9C12581EF0045762F/$File/fourth_industrial_revolution_2017__en.pdf "http://documents.epo.org/projects/babylon/eponet.nsf/0/17fdb5538e87b4b9c12581ef0045762f/$file/fourth_industrial_revolution_2017__en.pdf") by the European Patent Office found the number of patents filed related to the Fourth Industrial Revolution increased a growth rate of 54 percent in the past three years.

## Metaverse
### Definition
- Online virtual world where people can exist to live a "second life"
	- **Second Life** existed in the 2000s, essentially the same thing but without VR Headsets
	- Takes inspiration from *Ready Player One*'s Oasis
	- Roblox is also starting off there, many young children are up there... poor kids

### Technologies Available
- Sandbox - DeFi Metaverse place that looks like a video game from the 1990s
- Horizon Workrooms - Meta's new solution for Metaverse-based Work from Home
	- Have to use a virtual keyboard, cannot connect with real-world tools
- VRMeet - Less functional alternative to Horizon Workrooms, mostly only used for meetings
